        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-row justify-items-center text-center w-full mb-20">
              ...
              <div className="flex flex-col pr-20">
                  <div className={'hover:shadow-lg rounded-xl bg-gray-100 items-center text-xs w-64 p-4 hover:scale-105 ease-in-out duration-500 mt-[14rem] transform hover:translate-x-[-3rem]'}>
                    You may want to omit your GCSE grades and focus on your recent qualifications and experiences.
                  </div>
                  <div className={'hover:shadow-lg rounded-xl bg-gray-100 items-center text-xs w-64 p-4 hover:scale-105 ease-in-out duration-500 mt-[3rem] transform hover:translate-x-[-3rem]'}>
                  ...
                  <div className={'hover:shadow-lg rounded-xl bg-gray-100 items-center text-xs w-64 p-4 hover:scale-105 ease-in-out duration-500 mt-[5rem] transform hover:translate-x-[-3rem]'}>
                    Consider moving some of this detail to a cover letter to keep your resume concise and focused.
                  </div>
                  <div className={'hover:shadow-lg rounded-xl bg-gray-100 items-center text-xs w-64 p-4 hover:scale-105 ease-in-out duration-500 mt-[9rem] transform hover:translate-x-[-3rem]'}>
